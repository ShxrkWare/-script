...
DINOHUB.Name = "Ngdat Húp"
DINOHUB.Parent = game.CoreGui        --CoreGui
DINOHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling


do local GUI = game.CoreGui:FindFirstChild("Ngdat Húp");if GUI then GUI:Destroy();end;if _G.Color == Color3.fromRGB(189, 93, 240) then
...
function Update:Window(text,logo,keybind)
	...
	Hub.Text = ".lua"
	Hub.TextColor3 = Color3.fromRGB(189, 93, 240)
	Hub.TextSize = 17.000
...
local ver = Instance.new("TextLabel")
	...
	function uitab:Tab(text,icon)
		...
		function main:Button(text,callback)
			...
			Button.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
			...
			TextBtn.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
...
account_circle.ImageRectSize = Vector2.new(36, 36)
			...
			Circle.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
			...
			Button.MouseButton1Click:Connect(function()
				if toggled == false then
					...
					TweenService:Create(
						Circle,
						TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
						{BackgroundColor3 = Color3.fromRGB(189, 93, 240)}
					):Play()
				end
...
person.ImageRectSize = Vector2.new(36, 36)
		...
		function main:Slider(text,min,max,set,callback)
			...
			Slider.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
			...
			HAHA.Name = "HAHA"
			HAHA.Parent = sliderr
			HAHA.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
			...
			bar1.Name = "bar1"
			bar1.Parent = bar
			bar1.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
			...
			slidervalue.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
		...
		function main:Textbox(text,disappear,callback)
			...
			Textbox.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
		...
		function main:Seperator(text)
			...
			Seperator.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
			Seperator.BackgroundTransparency = 1.000
			Seperator.Size = UDim2.new(0, 470, 0, 20)
			
			Sep1.Name = "Sep1"
			Sep1.Parent = Seperator
			Sep1.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
			...
			Sep3.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
		...
		function main:Line()
			...
			Linee.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
			...
			Line.Name = "Line"
			Line.Parent = Linee
			Line.BackgroundColor3 = Color3.fromRGB(189, 93, 240)
                ...
                if DevilFruitESP then
                    if string.find(v.Name, "Fruit") then   
                        if not v.Handle:FindFirstChild('NameEsp'..Number) then
                            ...
                            name.BackgroundTransparency = 1
                            name.TextStrokeTransparency = 0.5
                            name.TextColor3 = Color3.fromRGB(189, 93, 240)
...
main:Label("Welcome "..game.Players.LocalPlayer.DisplayName.. " To NgdatWarelua")
main:Label("Ui Lib:Thái Dog")
