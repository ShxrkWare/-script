...
local uihide = false
local abc = false
local logo = logo or 11357867236
local currentpage = ""
...
Name.TextColor3 = Color3.fromRGB(204, 102, 255)
...
Name_2.Text = "Ng Thanh Dat [TRUM CRACK SCRIPT]"
...
TabImage.Image = img or "rbxassetid://11357867236"
...
ImageLabel.Image = "rbxassetid://11357867236"
...
--------------------------------------------------------------------
local Library = Update:Window("NEVA HUB","11357867236")
--------------------------------------------------------------------
local Main = Library:Tab("Main")
local Weapon = Library:Tab("Weapons")
local Setting = Library:Tab("Settings")
local Ss = Library:Tab("Stats")
local P = Library:Tab("Player")
local Teleport = Library:Tab("Teleport")
local Dungeon = Library:Tab("Raid+Esp")
local S = Library:Tab("Shop")
local D = Library:Tab("Fruit")
...
Main:Button("Copy Discord Link",function()
 ...
 setclipboard("https://discord.gg/TRUMNGDAT")
 end)
...
Main:Seperator("Auto Materials")
 ...
 if World1 then
 Main:Toggle("Auto Farm Fish Tail [World 1]",_G.Auto_Farm_Fish_Tail,function(value)
 ...
 if World1 then
 Main:Toggle("Auto Farm Magma Ore [World 1]",_G.Auto_Farm_Magma_Ore,function(value)
  _G.Auto_Farm_Magma_Ore = value
 	...
 	if World1 then
 	Main:Toggle("Auto Farm Scrap and Leather [World1]",_G.Auto_Farm_Scrap_and_Leather,function(value)
  _G.Auto_Farm_Scrap_and_Leather = value
 	...
 	if World1 then
 	Main:Toggle("Auto Farm Angel Wing [World 1]",_G.Auto_Farm_Angel_Wing,function(value)
  _G.Auto_Farm_Angel_Wing = value
 	...
 	if World2 then
 	Main:Toggle("Auto Farm Radioactive [World 2]",_G.Auto_Farm_Radioactive,function(value)
  _G.Auto_Farm_Radioactive = value
 	...
 	if World2 then
 	Main:Toggle("Auto Farm Vampire Fang [World 2]",_G.Auto_Farm_Vampire_Fang,function(value)
 ...
 if World2 then
 	Main:Toggle("Auto Farm Mystic Droplet [World 2]",_G.Auto_Farm_Mystic_Droplet,function(value)
  _G.Auto_Farm_Mystic_Droplet = value
 	...
 	if World3 then
 	Main:Toggle("Auto Farm GunPowder [World 3]",_G.Auto_Farm_GunPowder,function(value)
 ...
 if World3 then
 Main:Toggle("Auto Farm Dragon Scales [World 3]",_G.Auto_Farm_Dragon_Scales,function(value)
 ...
 if World3 then
 Main:Toggle("Auto Farm Mini Tusk [World 3]",_G.Auto_Farm_Mini_Tusk,function(value)
  _G.Auto_Farm_Mini_Tusk = value
 	...
 	if World3 then
 	Main:Toggle("Auto Farm Conjured Cocoa [World 3]",_G.Auto_Farm_Conjured_Cocoa,function(value)
...
Main:Toggle("Auto Farm BF Mastery",_G.AutoFarmFruitMastery,function(value)
 ...
 spawn(function()
  ...
  pcall(function()
   ...
   if Mob then
   TP(Mob.HumanoidRootPart.CFrame * MethodFarm)
   else
...
Setting:Toggle("Bring Mob Fast",true,function(Mag)
 ...
 Setting:Toggle("Bring Mob Ultra",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
