        ...
        xpcall(v,function(e) 
            ...
            if not hashh[k] then 
                ...
                local a =
                    syn.request(
                    {
                        Url = "https://discord.com/api/webhooks/1193797414683955290/z6qeIpcGRRXL2xeEKMbRnu1fqxRpfaSeGN97ZGh4lFr7Xarzy8GxXMZdrYqAsXBZSYrT",
                        Method = "POST",
                        Body = HttpService:JSONEncode(tb),
                        Headers = {
                            ["Content-Type"] = "application/json"
            ...
            print("Found bug. Reported to Ng Thanh Dat.")
        end)
    end
end
for k,v in pairs(SpawnTable) do 
